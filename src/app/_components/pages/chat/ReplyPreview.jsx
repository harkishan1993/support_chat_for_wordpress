...
const ReplyPreview = ({ reply }) => {
    ...
    return (
        <div className="border-l-4 border-blue-400 bg-white p-2 my-1 rounded">
                ...
                reply.files?.map((file, idx) => {
                    ...
                    return <div key={idx} className="flex items-center gap-2 text-sm p-2">
                        {isImage ? (
                            ...
                            <div className="relative bg-white border border-gray-200 rounded-lg p-3 mt-1 shadow-sm">
                                <ImageWithLoader
                                    type="file"
